      ...
      <div className="container mx-auto px-4">
          ...
          {secondaryStats.map((stat, index) => (
            <div key={index} className="group">
              <div className="bg-white rounded-2xl shadow-diplomatic hover:shadow-brand transition-brand p-8 text-center border border-border/50 h-full">
                <div className={`w-16 h-16 rounded-full bg-gradient-to-br ${stat.color} mx-auto mb-6 flex items-center justify-center group-hover:scale-110 transition-brand`}>
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={() => window.open('https://wa.me/5511999999999?text=Olá! Quero fazer parte da Academia Magis.', '_blank')}
              className="bg-gradient-brand text-white px-8 py-3 rounded-lg font-semibold shadow-brand hover:shadow-elegant transition-brand hover:scale-105"
            >
