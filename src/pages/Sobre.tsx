  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="Conheça a história da Academia MAGIS, nossa missão de democratizar Simulações Temáticas e atividades acadêmicas, e como formamos líderes diplomáticos do futuro." />
        <meta name="keywords" content="história academia MAGIS, missão valores, Simulações Temáticas, atividades acadêmicas, diplomacia acadêmica, liderança internacional, academia MAGIS sobre" />
        ...
        <meta property="og:description" content="Conheça a história da Academia MAGIS, nossa missão de democratizar Simulações Temáticas e atividades acadêmicas, e como formamos líderes diplomáticos do futuro." />
        ...
        <meta name="twitter:description" content="Conheça a história da Academia MAGIS, nossa missão de democratizar Simulações Temáticas e atividades acadêmicas, e como formamos líderes diplomáticos do futuro." />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="">
                ...
                <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                  Fundada em 2024, a Academia MAGIS nasceu do sonho de democratizar o mundo acadêmico - com destaque para as Simulações Temáticas.
                </p>
                <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                ...
                <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
                  Hoje somos referência regional em Simulações Temáticas, com dezenas de delegados enviados para inúmeros eventos.
                </p>
                <Button
                  onClick={handleWhatsApp}
