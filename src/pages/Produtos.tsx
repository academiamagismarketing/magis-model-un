...
const Produtos = () => {
  ...
  return (
    <>
      {/* SEO Head */}
      <Helmet>
        <title>Produtos Academia MAGIS | Pins, Kits e Materiais de Simulações Temáticas</title>
        ...
        <meta name="keywords" content="produtos academia MAGIS, pins Simulações Temáticas, kits delegado, materiais educacionais, produtos acadêmicos, academia MAGIS loja" />
        <meta name="author" content="Academia MAGIS" />
        <meta name="robots" content="index, follow" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Produtos Academia MAGIS | Pins, Kits e Materiais de Simulações Temáticas" />
        ...
        <meta name="twitter:title" content="Produtos Academia MAGIS | Pins, Kits e Materiais de Simulações Temáticas" />
